    ...
    <div className="w-full min-h-160 bg-gray-50">
      <div className="max-w-2xl mx-auto p-4 py-8">
        <form
          ...
          className="bg-white rounded-xl p-6 space-y-4 shadow-[0px_0px_30px_-16px_rgba(0,_0,_0,_0.8)]"
        >
          <button
            type="button"
            onClick={() => navigate(-1)}
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 cursor-not-allowed  bg-gray-100"
                disabled
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <select
                name="role"
                id="role"
                className="w-full px-4 py-2 border-2 border-blue-600 rounded-md focus:ring-blue-500 focus:border-blue-500 cursor-pointer"
                value={formData.role}
                onChange={handleInputChange}
              >
