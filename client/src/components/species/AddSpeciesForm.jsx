...
const AddSpeciesForm = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col gap-4 p-6 max-w-5xl mx-auto"
    >
      ...
      <button
        type="submit"
        className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 duration-200 transitaion-all ease-in-out hover:-translate-y-1 cursor-pointer"
        disabled={isLoading}
      >
        {isLoading ? "Adding..." : "Add Species"}
      </button>
    </form>
  );
};
